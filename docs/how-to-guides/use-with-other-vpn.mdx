...
This is possible, but in certain scenarios, additional configuration may be required; otherwise, it may not work properly.
...
<img src={useBaseUrl('/img/pages/rule_entry.png')} style={{width:"500px"}} />

### IP

<img src={useBaseUrl('/img/pages/ip_rule.png')} style={{width:"500px"}} />

### DOMAIN

<img src={useBaseUrl('/img/pages/domain_rule.png')} style={{width:"500px"}} />
